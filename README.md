...
| **Revoke StartOS Access**       | Remove Hermes' stored `start-cli` identity key from the data volume. Use this to revoke server-administration access; run **Login to StartOS** again to grant it back.                                                                                                                                                    |
